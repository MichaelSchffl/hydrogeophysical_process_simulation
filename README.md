...
<br/>
Now, it's possible to translate the simulated fluid concentration into geophysical properties if we assocaite the tracer concentration with salt content and assume dominance of electrolytic conduction. Then, the fluid resistivity <img src="https://render.githubusercontent.com/render/math?math={\rho_f}"> can be obtained by:
<img src="https://render.githubusercontent.com/render/math?math={\frac{1}{0.1 \cdot c + \sigma_0}}">, with
c: (salt-)tracer concentration [g/l]
<img src="https://render.githubusercontent.com/render/math?math={\sigma_0}">: conductivity of groundwater [S/m]
...
<img src="https://render.githubusercontent.com/render/math?math={\rho_b = a \cdot (1/\sigma_W)\cdot\phi^{-m}\cdot S^{-n}}">
a: tortuosity factor (usually a =1)
n: saturation exponent (usually n = 2)
m: cementation exponent
<img src="https://render.githubusercontent.com/render/math?math={\phi}">: porosity
